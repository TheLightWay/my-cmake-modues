...
set( VP_OUTPUT_DIR "${PROJECT_BINARY_DIR}" )

set( VP_OUTPUT_DIR_RUNTIME "${VP_OUTPUT_DIR}/bin" )
set( VP_OUTPUT_DIR_EXE "${VP_OUTPUT_DIR}/bin" )
set( VP_OUTPUT_DIR_ARH "${VP_OUTPUT_DIR}/lib" )

file( MAKE_DIRECTORY ${VP_OUTPUT_DIR_RUNTIME} )
file( MAKE_DIRECTORY ${VP_OUTPUT_DIR_ARH} )

set( CMAKE_RUNTIME_OUTPUT_DIRECTORY_DEBUG "${VP_OUTPUT_DIR_RUNTIME}" )
set( CMAKE_LIBRARY_OUTPUT_DIRECTORY_DEBUG "${VP_OUTPUT_DIR_RUNTIME}" )
set( CMAKE_ARCHIVE_OUTPUT_DIRECTORY_DEBUG  "${VP_OUTPUT_DIR_ARH}" )

set( CMAKE_RUNTIME_OUTPUT_DIRECTORY_RELEASE "${VP_OUTPUT_DIR_RUNTIME}" )
set( CMAKE_LIBRARY_OUTPUT_DIRECTORY_RELEASE "${VP_OUTPUT_DIR_RUNTIME}" )
set( CMAKE_ARCHIVE_OUTPUT_DIRECTORY_RELEASE "${VP_OUTPUT_DIR_ARH}" )

set( CMAKE_RUNTIME_OUTPUT_DIRECTORY_RELWITHDEBINFO "${VP_OUTPUT_DIR_RUNTIME}" )
set( CMAKE_LIBRARY_OUTPUT_DIRECTORY_RELWITHDEBINFO "${VP_OUTPUT_DIR_RUNTIME}" )
set( CMAKE_ARCHIVE_OUTPUT_DIRECTORY_RELWITHDEBINFO "${VP_OUTPUT_DIR_ARH}" )

set( CMAKE_RUNTIME_OUTPUT_DIRECTORY_MINSIZEREL "${VP_OUTPUT_DIR_RUNTIME}" )
set( CMAKE_LIBRARY_OUTPUT_DIRECTORY_MINSIZEREL "${VP_OUTPUT_DIR_RUNTIME}" )
set( CMAKE_ARCHIVE_OUTPUT_DIRECTORY_MINSIZEREL "${VP_OUTPUT_DIR_ARH}" )
...
if( VP_ENABLE_PROFILING )
    add_definitions( VP_USE_PROFILING )
endif( )

if( VP_ENABLE_LOGGING )
	add_definitions( VP_USE_LOGGING )
endif( )

if( VP_ENABLE_DOXYFILE )
	find_package( FindDoxygen REQUIRED dot )
	if( DOXYGEN_FOUND )
		add_definitions( VP_USE_DOXGEN )
	else( )
